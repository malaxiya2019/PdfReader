...
class DeletePagePage extends StatefulWidget {
  const DeletePagePage({super.key});

  @override
  State<DeletePagePage> createState() => _DeletePagePageState();
}

class _DeletePagePageState extends State<DeletePagePage> {
  String? _filePath;
  int _totalPages = 0;
  ...
  Future<void> _delete() async {
    ...
    final name = PdfToolService.timestampFileName('deleted_', 'pdf');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('删除页面'), centerTitle: true),
      body: Column(
        children: [
          Expanded(
            child: _loaded
                  ...
                  if (_loaded)
                    Expanded(
                      ...
                      child: FilledButton.icon(
                        onPressed: _selectedPages.isEmpty || _isProcessing
                            ? null
                            : _delete,
                        icon: _isProcessing
                            ? const SizedBox(
